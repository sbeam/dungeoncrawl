...
impl CellularAutomataArchitect {
    ...
    fn count_neighbors(&self, x: i32, y: i32, map: &mut Map) -> i32 {
        let mut neighbors = 0;
        for iy in -1..=1 {
            for ix in -1..=1 {
    ...
    fn find_start(&self, map: &Map) -> Point {
        ...
        // this goes through every Floor tile, calculates the 2d distance, gets the
        // min distance. So the floor tile closest to the center
